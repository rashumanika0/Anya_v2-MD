...
module.exports = {
  botname: process.env.BotName || "Queen Rashu", 
  author: process.env.Author || "@PikaBotz",
  packname: process.env.PackName || "Queen Rashu v2 MD",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Queen Anya Bot",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "NR-RASHU-MODZ",
  ownernumber: process.env.Owner_Number || "94779122081",
  adress: process.env.Continent || "Sri Lanka",
  timezone: process.env.TimeZone || "Asia/Kolombo", 
